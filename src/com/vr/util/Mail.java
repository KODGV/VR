...
//           message.addRecipients(MimeMessage.RecipientType.TO, InternetAddress.parse(receiveMail));
//           message.setSubject("老师你好", "UTF-8");
...
////           message.saveChanges();
//           message.setContent(new String(t.getBytes(),"UTF-8"), "text/html;charset=UTF-8");
//           System.out.println((String)message.getContent());
//           message.setSentDate(new Date());
//           message.saveChanges();
//           return message;
