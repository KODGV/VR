...
public class VotedUserDaoImpl extends HibernateUtils implements VotedUserDao{
	...
	private Object getVotedUser(String name, int userid)
	{
		String hql="from VotedUser a where a.id.userid=? and a.id.name=?";
		return findByHql(hql, new Object[]{userid,name});
	}
}
