...
public class EncyclopediaDaoImpl  extends HibernateUtils implements EncyclopediaDao {
	...
	public boolean up(int id) {
		// TODO Auto-generated method stub
		Encyclopedia ency=(Encyclopedia)findByHql("from Encyclopedia n where n.id=?",new Object[]{id});
		int upvote=ency.getUpvote();
		upvote=upvote+1;
		ency.setUpvote(upvote);
		return update(ency);
	}
	...
	public boolean down(int id) {
		// TODO Auto-generated method stub
		Encyclopedia ency=(Encyclopedia)findByHql("from Encyclopedia n where n.id=?",new Object[]{id});
		int downvote=ency.getDownvote();
		downvote=downvote+1;
		ency.setDownvote(downvote);
		return update(ency);
	}

	@Override
	public List<Object> getAllEncyclopedia(int pageNo,int pageNum) {
		// TODO Auto-generated method stub
		String hql="from Encyclopedia";
