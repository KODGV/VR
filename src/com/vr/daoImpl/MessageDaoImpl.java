...
public class MessageDaoImpl extends HibernateUtils implements MessageDao{
	...
	public Object getMessageById(int id,String type) {
	   ...
	   public boolean deleteMessageByPostId(String obj) {
		   return deleteall(obj);
	   }
	   
	   @Override
		public List<Object> getResponseByCondition(String condition,int pageNo,String type,String belong) {
			// TODO Auto-generated method stub
			String hql = "from "+type+" a "+"where a.messageLeaving="+belong;
			hql+=" order by ";
			hql+=condition;
			return listpage(hql,pageNo, 10);
		}
